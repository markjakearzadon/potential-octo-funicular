  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Configuration##2")) {
      ...
      if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable) {
        ...
        ImGui::SameLine();
        HelpMarker(
            "Enable docking when holding Shift only (allow to drop in wider "
            "space, reduce visual noise)");
        ...
        ImGui::SameLine();
        HelpMarker(
            "Make window or viewport transparent when docking and only display "
            "docking boxes on the target viewport. Useful if rendering of "
            "multiple viewport cannot be synced. Best used with "
      ...
      ImGui::SameLine();
      HelpMarker(
          "[beta] Enable beta multi-viewports support. See ImGuiPlatformIO for "
          "details.");
      if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) {
        ...
        ImGui::SameLine();
        HelpMarker(
            "Set to make all floating imgui windows always create their own "
            "viewport. Otherwise, they are merged into the main host viewports "
            "when overlapping it.");
  ...
  if (ImGui::BeginCombo(label, font_current->GetDebugName())) {
    for (ImFont* font : io.Fonts->Fonts) {
      ...
      if (ImGui::Selectable(font->GetDebugName(), font == font_current))
        io.FontDefault = font;
      if (font == font_current) ImGui::SetItemDefaultFocus();
      ImGui::PopID();
    }
    ImGui::EndCombo();
  }
  ...
  if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (ImGui::BeginTabItem("Sizes")) {
      ...
      ImGui::DragFloat(
          ...
          &style.TabCloseButtonMinWidthSelected, 0.1f, -1.0f, 100.0f,
          (style.TabCloseButtonMinWidthSelected < 0.0f) ? "%.0f (Always)"
                                                        : "%.0f");
      ImGui::DragFloat(
          "TabCloseButtonMinWidthUnselected",
          &style.TabCloseButtonMinWidthUnselected, 0.1f, -1.0f, 100.0f,
      ...
      ImGui::SliderFloat2("WindowTitleAlign", (float*)&style.WindowTitleAlign,
                          0.0f, 1.0f, "%.2f");
      ImGui::SliderFloat("WindowBorderHoverPadding",
      ...
      ImGui::SliderFloat("LogSliderDeadzone", &style.LogSliderDeadzone, 0.0f,
                         12.0f, "%.0f");
      ImGui::SliderFloat("ImageBorderSize", &style.ImageBorderSize, 0.0f, 1.0f,
                         "%.0f");
